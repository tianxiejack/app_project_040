...
int main_egl(int argc, char **argv)
{
	...
	dsInit.channelInfo[0].w = SYS_CHN_WIDTH(0);
	dsInit.channelInfo[0].h = SYS_CHN_HEIGHT(0);
	dsInit.channelInfo[0].c = 3;
	dsInit.channelInfo[1].w = SYS_CHN_WIDTH(1);
	dsInit.channelInfo[1].h = SYS_CHN_HEIGHT(1);
	dsInit.channelInfo[1].c = 3;
